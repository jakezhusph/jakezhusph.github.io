...
for(isid in 1:10){
	load(paste0(outpath,"/sim_spark_CN24_D1_",iblock,"X_",layerlist[ilayer],"_zero",numZero,"_sigzero",sigZero,"_means_blocked_binR_rpt",isid,".rds"))	
...
p1 <- p2 <- c()
for(irpt in 1:10){
	res <- read.table(paste0(outpath,"/sim_spe_CN24_D1_",iblock,"X_",layerlist[ilayer],"_zero",numZero,"_sigzero",sigZero,"_means_blocked_binR_rpt",irpt,".csv"),head=T)
...
#' ***
#' > Figure 1: 38X Resolution QQ Plots of Null Genes, GL Layer
...
#' ***
#' > Figure 2: 1X Resolution QQ Plots, GL Layer
...
load(paste0(simpath,"/sim_data_CN24_D1_",iblock,"X_",layerlist[ilayer],"_zero",numZero,"_sigzero",sigZero,"_means_binR_rpt",isid,".rds"))

sp_sim_count = round(sp_sim_count*iblock^2)
