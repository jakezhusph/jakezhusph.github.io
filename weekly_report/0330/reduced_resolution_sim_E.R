...
#' ***
#' > Figure 1: 50X Resolution QQ Plots of Null Genes, E layer
...
#' ***
#' > Figure 4: 50X Resolution Gene Expression Pattern
...
#' ***
#' KDC 50X *p*-values 
#+ label=patkdc50x, echo=F, warnings=F, message=F,eval=T
rm(list=ls())
