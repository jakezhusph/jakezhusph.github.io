#' ---
#' title: "RCTD Confident Cell Analysis II: XTX"
#' author: "Jiaqiang Zhu"
#' date: "June 12th, 2020"
#' ---
...
selected_sp_count <- sp_count[both_genes,]-sp_count[both_genes,]%*%cate_x%*%XTX_inv%*%t(cate_x)
...
XTX_inv         <- solve(crossprod(cate_x,cate_x))
selected_sp_count <- sp_count[no_cell_genes,]-sp_count[no_cell_genes,]%*%cate_x%*%XTX_inv%*%t(cate_x)
